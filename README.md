...
- [Glitch](https://idliapam.in/glitch) - AI-powered bug reporting. Users report bugs with voice recordings, screenshots, and screen recordings. AI auto-triages severity and suggests fixes. ([Source Code](https://github.com/Ankitajainkuniya/glitch-widget)) `MIT` `Nodejs`
